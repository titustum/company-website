...
new #[\Livewire\Attributes\Title('Contact Us | South-End Tech Limited')] class extends Component
{
        ...
        <div class="relative max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-3 gap-6">
                <a href="tel:+254728223333" data-aos="fade-up"
                    class="industry-card group cursor-pointer">
                    <div class="industry-icon bg-amber-100 dark:bg-amber-500/20">
                        <ion-icon name="call-outline" class="text-amber-600"></ion-icon>
                    </div>
                    <h3>Call Us</h3>
                    <p>+254 728 223 333<br>Mon – Fri, 8:00am – 5:00pm EAT</p>
                    <span
                        class="inline-flex items-center gap-1 mt-4 text-sm font-semibold text-blue-700 dark:text-blue-400">Give
                        us a call <ion-icon name="arrow-forward-outline"></ion-icon></span>
                </a>
                <a href="mailto:info@southendtech.co.ke" data-aos="fade-up" data-aos-delay="100"
                    ...
                    <div class="industry-icon bg-blue-100 dark:bg-blue-900/40">
                        <ion-icon name="mail-outline" class="text-blue-900 dark:text-blue-400"></ion-icon>
                    </div>
                    <h3>Email Us</h3>
                    <p>info@southendtech.co.ke<br>We reply within one business day.</p>
                    <span
                        class="inline-flex items-center gap-1 mt-4 text-sm font-semibold text-blue-700 dark:text-blue-400">Send
                        an email <ion-icon name="arrow-forward-outline"></ion-icon></span>
                </a>
                <div data-aos="fade-up" data-aos-delay="200" class="industry-card">
                    <div class="industry-icon bg-amber-100 dark:bg-amber-500/20">
                        <ion-icon name="location-outline" class="text-amber-600"></ion-icon>
                    </div>
                    <h3>Visit Us</h3>
                    <p>NML Towers, Second Floor, Office No. 207, Tsavo Road, Nairobi, Kenya</p>
                    <span
                        class="inline-flex items-center gap-1 mt-4 text-sm font-semibold text-blue-700 dark:text-blue-400">Find
                        us below <ion-icon name="arrow-down-outline"></ion-icon></span>
                </div>
            </div>
        </div>
    </section>
                    ...
                    @else
                        <form wire:submit="submit"
                            ...
                            <div class="grid sm:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <select id="subject" wire:model="subject"
                                        ...
                                        @foreach (['General Inquiry', 'Data Protection', 'Cybersecurity', 'Data & AI', 'Digital Consulting', 'Partnership', 'Careers'] as $option)
                            ...
                            <div>
                                ...
                                <textarea id="message" wire:model="message" rows="5" placeholder="Tell us about your organization and what you need help with..."
                    ...
                    <div data-aos="fade-left" data-aos-delay="200" class="why-card">
                        ...
                        <div class="flex gap-3 mt-5">
                            <a href="#" aria-label="LinkedIn"
                                class="w-11 h-11 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center hover:bg-accent-yellow transition"><ion-icon
                                    name="logo-linkedin" class="text-xl"></ion-icon></a>
                            <a href="#" aria-label="Twitter / X"
                                class="w-11 h-11 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center hover:bg-accent-yellow transition"><ion-icon
                                    name="logo-twitter" class="text-xl"></ion-icon></a>
                            <a href="#" aria-label="Facebook"
                                class="w-11 h-11 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center hover:bg-accent-yellow transition"><ion-icon
                                    name="logo-facebook" class="text-xl"></ion-icon></a>
                        </div>
                    </div>
                </div>
            </div>
